...
-- vim.g.nvim_vim_tree_side = 'right' -- Left by default
...
--TODO
--vim.g:nvim_tree_root_folder_modifier = '%:p:h' --This is the default. See :help filename-modifiers for more options


-- each of these are documented in `:help nvim-tree`
